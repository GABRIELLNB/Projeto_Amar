"""
Django settings for back_amar project.
...
SECRET_KEY = 'django-insecure-85t+6)9#uetp(u(+8))xj7p01frvcw3@p#2k_+kzu&qug&8thl'
...
MIDDLEWARE = [
    'corsheaders.middleware.CorsMiddleware',  # coloque esta linha logo no topo
...
WSGI_APPLICATION = 'back_amar.wsgi.application'
...
DATABASES = {
     'default': {
        ...
        'NAME': 'BD_AMAR',
        'USER': 'root',
        'PASSWORD': 'ABlSrsDvSBVCxNdSRNhtaJRtKYQfZKfc',  
